 ...
 */
public class  Taj_Activity extends AppCompatActivity
    ...
    private static final LatLng Acro = new LatLng(24.482856833769684, 39.63745483863913);
...
//            marker.setPosition(location.position);
    ...
    public void onMapReady( GoogleMap googleMap)
    {
        ...
        Geocoder geocoder=new Geocoder(Taj_Activity.this);
        try
        {
            addressList=geocoder.getFromLocation(24.482856833769684, 39.63745483863913,1);
        }
        catch (IOException e)
        {
            e.printStackTrace();
        ...
        googleMap.addMarker(new MarkerOptions().position(Acro).title("Masjid e Nabwi(S.A.W)"));
