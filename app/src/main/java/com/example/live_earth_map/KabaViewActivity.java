 ...
 */
public class  KabaViewActivity extends AppCompatActivity
    ...
    private static final LatLng Acro = new LatLng(21.42263769671107, 39.82632046436436);
...
//            marker.setPosition(location.position);
    ...
    public void onMapReady( GoogleMap googleMap)
    {
        ...
        List<Address> addressList=null;
            ...
            Geocoder geocoder=new Geocoder(KabaViewActivity.this);
            try
            {
                addressList=geocoder.getFromLocation(21.42263769671107, 39.82632046436436,1);
            }
            catch (IOException e)
            {
                e.printStackTrace();
           ...
           // LatLng latLng=new LatLng(address.getLatitude(),address.getLongitude());
            googleMap.addMarker(new MarkerOptions().position(Acro).title("Kaba"));
