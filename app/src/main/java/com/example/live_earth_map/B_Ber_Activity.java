 ...
 */
public class  B_Ber_Activity extends AppCompatActivity
    ...
    private static final LatLng Acro = new LatLng(52.51636597633687, 13.378176165888936);
...
//            marker.setPosition(location.position);
    ...
    public void onMapReady( GoogleMap googleMap)
    {
        ...
        Geocoder geocoder=new Geocoder(B_Ber_Activity.this);
        try
        {
            addressList=geocoder.getFromLocation(52.51636597633687, 13.378176165888936,1);
        }
        catch (IOException e)
        {
            e.printStackTrace();
        ...
        googleMap.addMarker(new MarkerOptions().position(Acro).title("Braden Berg Germany"));
