 ...
 */
public class  T_B_Activity extends AppCompatActivity
    ...
    private static final LatLng Acro = new LatLng(51.505917155468474, -0.07387592366843963);
...
//            marker.setPosition(location.position);
    ...
    public void onMapReady( GoogleMap googleMap)
    {
        ...
        Geocoder geocoder=new Geocoder(T_B_Activity.this);
        try
        {
            addressList=geocoder.getFromLocation(51.50558325473614, -0.07504536668972973,1);
        }
        catch (IOException e)
        {
            e.printStackTrace();
        ...
        googleMap.addMarker(new MarkerOptions().position(Acro).title("Tower"));
