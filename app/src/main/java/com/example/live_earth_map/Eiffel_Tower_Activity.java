 ...
 */
public class  Eiffel_Tower_Activity extends AppCompatActivity
    ...
    private static final LatLng Acro = new LatLng(48.85860300933046, 2.2951250270627943);
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_eiffel_tower);
...
//            marker.setPosition(location.position);
    ...
    public void onMapReady( GoogleMap googleMap)
    {
        ...
        Geocoder geocoder=new Geocoder(Eiffel_Tower_Activity.this);
        try
        {
            addressList=geocoder.getFromLocation(48.85860300933046, 2.2951250270627943,1);
        }
        catch (IOException e)
        {
            e.printStackTrace();
        ...
        googleMap.addMarker(new MarkerOptions().position(Acro).title("Eiffel Tower"));
