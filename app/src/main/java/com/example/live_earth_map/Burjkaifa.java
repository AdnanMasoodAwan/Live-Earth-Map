 ...
 */
public class  Burjkaifa extends AppCompatActivity
    ...
    private static final LatLng Acro = new LatLng(25.1974008447064, 55.27464461711908);
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_burjkaifa);
...
//            marker.setPosition(location.position);
    ...
    public void onMapReady( GoogleMap googleMap)
    {
        ...
        Geocoder geocoder=new Geocoder(Burjkaifa.this);
        try
        {
            addressList=geocoder.getFromLocation(25.19743967649277, 55.274676803626654,1);
        }
        catch (IOException e)
        {
            e.printStackTrace();
        ...
        Map.addMarker(new MarkerOptions().position(Acro).title("Burj Khalifa"));
