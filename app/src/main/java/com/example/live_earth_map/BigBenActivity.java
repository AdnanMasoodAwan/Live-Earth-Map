 ...
 */
public class  BigBenActivity extends AppCompatActivity
    ...
    private static final LatLng Acro = new LatLng(51.50088278270016, -0.12467368268082618);
...
//            marker.setPosition(location.position);
    ...
    public void onMapReady( GoogleMap googleMap)
    {
        ...
        Geocoder geocoder=new Geocoder(BigBenActivity.this);
        try
        {
            addressList=geocoder.getFromLocation(51.50088278270016, -0.12467368268082618,1);
        }
        catch (IOException e)
        {
            e.printStackTrace();
        ...
        googleMap.addMarker(new MarkerOptions().position(Acro).title("Big Ben"));
