 ...
 */
public class  Louvre_Activity extends AppCompatActivity
    ...
    private static final LatLng Acro = new LatLng(48.860759298094365, 2.338062421526709);
...
//            marker.setPosition(location.position);
    ...
    public void onMapReady( GoogleMap googleMap)
    {
        ...
        Geocoder geocoder=new Geocoder(Louvre_Activity.this);
        try
        {
            addressList=geocoder.getFromLocation(48.860759298094365, 2.338062421526709,1);
        }
        catch (IOException e)
        {
            e.printStackTrace();
        ...
        googleMap.addMarker(new MarkerOptions().position(Acro).title("Louvire"));
