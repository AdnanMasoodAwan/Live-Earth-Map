 ...
 */
public class  London_Eye_Activity extends AppCompatActivity
    ...
    private static final LatLng Acro = new LatLng(51.50335333126961, -0.11924025319500796);
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_london_eye);
...
//            marker.setPosition(location.position);
    ...
    public void onMapReady( GoogleMap googleMap)
    {
        ...
        Geocoder geocoder=new Geocoder(London_Eye_Activity.this);
        try
        {
            addressList=geocoder.getFromLocation(51.50335333126961, -0.118982761153623,1);
        }
        catch (IOException e)
        {
            e.printStackTrace();
        ...
        googleMap.addMarker(new MarkerOptions().position(Acro).title("London Eye"));
